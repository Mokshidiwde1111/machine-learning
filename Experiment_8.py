# Mokshi Diwde 0827CI201111   # Import Libraries import numpy as np import pandas 
...
# Mokshi Diwde 0827CI201111  # Get dummy variable  y = pd.get_dummies(y).values 
 y[:3] 
# Mokshi Diwde 0827CI201111 
...
# Mokshi Diwde 0827CI201111  def sigmoid(x): 
...
# Mokshi Diwde 0827CI201111  for itr in range(iterations):     
...
# Mokshi Diwde 0827CI201111   results.mse.plot(title="Mean Squared Error") 
# Mokshi Diwde 0827CI201111   results.accuracy.plot(title="Accuracy") 
# Mokshi Diwde 0827CI201111
Z1 = np.dot(x_test, W1) 
A1 = sigmoid(Z1) 
