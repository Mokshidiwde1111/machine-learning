# Mokshi Diwde 0827CI201111 magic, n = struct.unpack('>II', lbpath.read(8)) labels = np.fromfile(lbpath, dtype=np.uint8) 
# Mokshi Diwde 0827CI201111  import numpy as np import pandas as pd import matplotlib.pyplot as plt my_list = [1, 2, 3, 4, 5] my_tuple = (6, 7, 8, 9, 10) my_string = "Hello, world!" my_dict = {'name': 'John', 'age': 30, 'city': 'New York'} multiply = lambda x, y: x * y class Person:     def _init_(self, name, age): 
