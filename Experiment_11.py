...
# Mokshi Diwde 0827CI201111 from
tensorflow.keras.models import Sequential from
tensorflow.keras.layers import Conv2D, MaxPooling2D,Flatten,Dense
#define cnn architecture
# Mokshi Diwde 0827CI201111   from tensorflow.keras.models import Sequential from tensorflow.keras.layers import Conv2D, MaxPooling2D, Flatten, Dense  
...
# Mokshi Diwde 0827CI201111 # Evaluate the model on the test set test_loss, test_acc = model.evaluate(x_test, tf.keras.utils.to_categorical(y_test)) print('Test accuracy:', test_acc) 
