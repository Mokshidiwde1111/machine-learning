...
#Mokshi Diwde 0827CI201111  # Get dummy variable  y = pd.get_dummies(y).values  y[:3]  
#Mokshi Diwde 0827CI201111  
#Split data into train and test data 
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=20, random_state=4) 
#Mokshi Diwde 0827CI201111   # Initialize variables learning_rate = 0.1 iterations = 5000 
N = y_train.size 
...
#Mokshi Diwde 0827CI201111  import numpy as np import tensorflow as tf 
