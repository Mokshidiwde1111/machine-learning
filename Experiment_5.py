# Mokshi Diwde 0827CI201111  import pandas as pd 
...
# Mokshi Diwde 0827CI201111  class LinearRegression: 
         def __init__(self): 
        ...
        # Make predictions using the coefficients         y_pred = X.dot(self.coefficients) 
                 return y_pred 
# Mokshi Diwde 0827CI201111 import numpy as np 
...
# Mokshi Diwde 0827CI201111   # Make predictions on the testing data y_pred = lr.predict(X_test)  
# Print the predictions 
print(y_pred) 
# Mokshi Diwde 0827CI201111  import pandas as pd import numpy as np from sklearn.model_selection import train_test_split 
